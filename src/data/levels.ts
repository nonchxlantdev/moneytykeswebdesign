...
export const learningLevels: LearningLevel[] = [
  ...
  },
  {
    ...
    name: 'Pathfinders',
    ageRange: '11–13',
    description: 'Advanced savings, vendor purchases, and financial challenges.',
    skills: ['Vendor spending', 'Challenges', 'Interest concepts'],
  ...
  },
  {
    ...
    name: 'Master Tykes',
    ageRange: '14–17',
    description: 'Real-world financial literacy, entrepreneurship, and long-term planning.',
